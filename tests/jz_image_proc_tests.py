...
class TestImageProc(unittest.TestCase):
    def test_gaussian_blur_correct_output(self):
        input_img = Image.open("test_images/test_1.JPG")

        # Blur radius: 9
        expected_img = Image.open("test_images/test_1_gaussian_1.jpg")

        output = gaussian_blur(input_img, 9)
        output.save('test_images/output.jpg')

        output_img = Image.open('test_images/output.jpg')
        ...
        # Blur radius: 2
        expected_img = Image.open("test_images/test_1_gaussian_2.jpg")
    ...
    def test_saturation_correct_output(self):
        ...
        # Saturation: 0.5
        expected_img = Image.open("test_images/test_1_saturation_1.jpg")
        ...
        # Saturation: 1.5
        expected_img = Image.open("test_images/test_1_saturation_2.jpg")
    ...
    def test_watermark_text_correct_output(self):
        ...
        expected_img = Image.open("test_images/test_1_watermark_1.jpg")
        ...
        # Text: "Hello", Position:
        # expected_img = Image.open("test_images/test_1_thumbnail_2.jpg")
        #
    ...
    def test_scale_image_correct_output(self):
        ...
        # 0.1
        expected_img = Image.open("test_images/test_1_thumbnail_1.jpg")
    ...
    def test_rotate_image_correct_output(self):
        ...
        # 90 degrees
        expected_img = Image.open("test_images/test_1_rotate_1.jpg")
        ...
        # 370 degrees
        expected_img = Image.open("test_images/test_1_rotate_2.jpg")
